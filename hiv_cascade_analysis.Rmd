...
data_list <- list(treat_cascade_all, treat_cascade_m_adult, treat_cascade_f_adult, test_treat_cascade_all, test_treat_cascade_m_adult, test_treat_cascade_f_adult, know_status_all, on_art_all, vl_suppress_all, treat_cascade_all_global, treat_cascade_m_adult_global, treat_cascade_f_adult_global, test_treat_cascade_all_global, test_treat_cascade_m_adult_global, test_treat_cascade_f_adult_global, know_status_all_global, on_art_all_global, vl_suppress_all_global)
```
...
# replace "..." values with NA for all datasets
data_list <- map(data_list, na_if, "...")
