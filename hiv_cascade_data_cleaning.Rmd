---
title: "HIV Treatment Cascade - Data Cleaning"
...
This file provides a script for cleaning the HIV treatment cascade data from UNAIDS from 2015-2018 related to progress towards the 90-90-90 targets.
...
write_rds(full_cascade_global_tidy, "data/tidy_data/full_cascade_global_tidy")
```
...
# save RDS object
write_rds(full_cascade_country_tidy, "data/tidy_data/full_cascade_country_tidy")
```
...
# save RDS objects
write_rds(know_status_all_global_tidy, "data/tidy_data/know_status_all_global_tidy")
write_rds(on_art_all_global_tidy, "data/tidy_data/on_art_all_global_tidy")
write_rds(vl_suppress_all_global_tidy, "data/tidy_data/vl_suppress_all_global_tidy")
write_rds(know_status_all_tidy, "data/tidy_data/know_status_all_country_tidy")
write_rds(on_art_all_tidy, "data/tidy_data/on_art_all_country_tidy")
write_rds(vl_suppress_all_tidy, "data/tidy_data/vl_suppress_all_country_tidy")
